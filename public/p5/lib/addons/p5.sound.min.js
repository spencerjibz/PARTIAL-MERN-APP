...
!(function (t, e) {
  ...
  r = (function () {
    var e = i,
      n = e.audiocontext;
    "undefined" != typeof n.createStereoPanner
      ? ((t.Panner = function (t, e) {
          (this.stereoPanner = this.input = n.createStereoPanner()),
      ...
      : ((t.Panner = function (t, e, i) {
          (this.input = n.createGain()),
            ...
            (this.left = n.createGain()),
            (this.right = n.createGain()),
            (this.left.channelInterpretation = "discrete"),
            (this.right.channelInterpretation = "discrete"),
            i > 1
              ? ((this.splitter = n.createChannelSplitter(2)),
                this.input.connect(this.splitter),
                this.splitter.connect(this.left, 1),
                this.splitter.connect(this.right, 0))
              : (this.input.connect(this.left), this.input.connect(this.right)),
            (this.output = n.createChannelMerger(2)),
    ...
    (t.Oscillator = function (i, n) {
      ...
      (t.Oscillator.prototype.start = function (t, i) {
        ...
        if (!this.started) {
          ...
          this.oscillator &&
            (this.oscillator.disconnect(), (this.oscillator = void 0)),
            (this.oscillator = e.audiocontext.createOscillator()),
  ...
  q = (function () {
    ...
    (t.Pulse = function (i, o) {
      t.Oscillator.call(this, i, "sawtooth"),
        (this.w = o || 0),
        (this.osc2 = new t.SawOsc(i)),
        (this.dNode = n.audiocontext.createDelay()),
        (this.dcOffset = e()),
        (this.dcGain = n.audiocontext.createGain()),
      ...
      (t.Pulse.prototype.start = function (t, i) {
        ...
        if (!this.started) {
          ...
          (this.oscillator = n.audiocontext.createOscillator()),
            this.oscillator.frequency.setValueAtTime(s, o),
            (this.oscillator.type = a),
            this.oscillator.connect(this.output),
            this.oscillator.start(r + o),
            (this.osc2.oscillator = n.audiocontext.createOscillator()),
      ...
      (t.Pulse.prototype.stop = function (t) {
        if (this.started) {
          ...
          this.oscillator.stop(e + i),
            this.osc2.oscillator.stop(e + i),
            this.dcOffset.stop(e + i),
            (this.started = !1),
            (this.osc2.started = !1);
        }
      }),
      (t.Pulse.prototype.freq = function (t, e, i) {
        if ("number" == typeof t) {
          ...
          this.oscillator.frequency.cancelScheduledValues(o),
            this.oscillator.frequency.setValueAtTime(r, o + i),
            this.oscillator.frequency.exponentialRampToValueAtTime(
              t,
              i + e + o,
            ),
            this.osc2.oscillator.frequency.cancelScheduledValues(o),
            this.osc2.oscillator.frequency.setValueAtTime(r, o + i),
  ...
  tt = (function () {
    var e = i,
      n = K;
    (t.Metro = function () {
      (this.clock = new n({ callback: this.ontick.bind(this) })),
        (this.syncedParts = []),
        (this.bpm = 120),
        this._init(),
        (this.prevTick = 0),
  ...
  ot = (function () {
    ...
    (t.SoundRecorder = function () {
      ...
      (t.prototype.saveSound = function (i, o) {
        var r, s;
        (r = i.buffer.getChannelData(0)),
          (s = i.buffer.numberOfChannels > 1 ? i.buffer.getChannelData(1) : r);
        var a = e(r, s),
  ...
  at = (function () {
    ...
    return (
      ...
      (t.AudioVoice.prototype._setNote = function (e) {
        var i = { A: 21, B: 23, C: 24, D: 26, E: 28, F: 29, G: 31 },
          n = i[e[0]],
          o = "number" == typeof Number(e.slice(-1)) ? e.slice(-1) : 0;
        return (
          (n += 12 * o),
          (n = "#" === e[1] ? n + 1 : "b" === e[1] ? n - 1 : n),
          t.prototype.midiToFreq(n)
        );
      }),
  ...
  ct = (function () {
    ...
    (t.PolySynth = function (i, o) {
      (this.audiovoices = []),
        ...
        (this._oldest = 0),
        (this.polyValue = o || 8),
        (this.AudioVoice = void 0 === i ? t.MonoSynth : i),
        (this._voicesInUse = new n(0)),
        (this.output = e.audiocontext.createGain()),
        this.connect(),
      ...
      (t.PolySynth.prototype.noteAttack = function (i, o, r) {
        var s,
          ...
          p =
            "string" == typeof i
              ? this.AudioVoice.prototype._setNote(i)
              : "number" == typeof i
              ? i
              : 440,
          h = void 0 === o ? 1 : o;
        if (
          (void 0 !== this.notes[p] &&
            null !== this.notes[p].getValueAtTime(c) &&
            this.noteRelease(p, 0),
          this._voicesInUse.getValueAtTime(c) < this.polyValue)
        )
          s = this._voicesInUse.getValueAtTime(c);
        else {
          s = this._oldest;
          var l = t.prototype.freqToMidi(
        ...
        var f =
          null === this._voicesInUse._searchBefore(c)
            ? 0
            : this._voicesInUse._searchBefore(c).value;
        if (
          (this._voicesInUse.setValueAtTime(f + 1, c),
          this._updateAfter(c, 1),
          (this._newest = s),
          "number" == typeof h)
        ) {
      ...
      (t.PolySynth.prototype.noteRelease = function (t, i) {
        var n =
            "string" == typeof t
              ? this.AudioVoice.prototype._setNote(t)
              : "number" == typeof t
              ? t
        ...
        if (null === this.notes[n].getValueAtTime(s))
          ...
          var a =
            null === this._voicesInUse._searchBefore(s)
              ? 0
              : this._voicesInUse._searchBefore(s).value;
          this._voicesInUse.setValueAtTime(a - 1, s),
            this._updateAfter(s, -1),
            this.audiovoices[this.notes[n].getValueAtTime(s)].triggerRelease(r),
            this.notes[n].setValueAtTime(null, s),
            (this._newest =
              0 === this._newest
                ? 0
